...
export default class Editor extends Component {
    ...
    open(page, cb){
        ...
        axios
            ...
            .then(() => this.iframe.load("../retfgdf_rtrt.html"))
   ...
   async save(onSuccess, onError) {
    ...
    restoreBackup(e, backup){
        ...
        UIkit.modal.confirm("Вы действительно хотите восстановить страницу из данной копии? Все не сохраненные данные будут потеряны!", {labels: {ok: 'Восстановить', cancel: 'Отмена'}})
        .then(() => {
            this.isLoading();
            return axios
